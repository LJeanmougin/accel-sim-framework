...
./util/job_launching/run_simulations.py -B rodinia-3.1_1w -C ORIN_5l-PTX -N rodinia-3.1_1w -l local -r rodinia_1w_5l_fix_test
...
# ./util/job_launching/run_simulations.py -B rodinia-3.1 -C ORIN_400l-PTX -N rodinia-3.1 -l local -r ecrts_1b_400l
RED='\033[0;31m'
NC='\033[0m'
